function [mean_of_amplitude12,mean_of_amplitude21,S1_to_S2_range_t,S2_to_S1_range_t,ratio] = CalculateAmplitude(heart_sounds,fs,w)
...
for e = 1:length(heart_sounds)-1
    if heart_sounds(e,2) == 1 && heart_sounds(e+1,2) == 2 %
        S1_to_S2_range_t(e,1) = heart_sounds(e,3);% S1 bound off
        S1_to_S2_range_t(e,2) = heart_sounds(e+1,1);% S2 bound on
    end
end
